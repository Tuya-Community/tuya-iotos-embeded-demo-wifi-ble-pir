# Tuya IoTOS Embeded Demo WiFi & BLE pir
...
本 Demo 基于涂鸦智能云平台、涂鸦智能APP、IoTOS Embeded WiFi &Ble SDK，使用涂鸦WiFi/WiFi+BLE系列模组快速组建一个人体存在传感器demo，可以通过手机app设置传感器的距离和触发持续时间，并显示触发情况。
## 快速上手
